...
export const WHY_CHOOSE = [
  { title: 'Guaranteed Rental Income', desc: 'Consistent rent, even during vacancy.', icon: 'BadgeCheck' },
  { title: 'Maximized Revenue', desc: 'High occupancy & better returns.', icon: 'TrendingUp' },
